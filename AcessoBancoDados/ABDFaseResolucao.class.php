<?PHP
  ...
  class ABDFaseResolucao extends FaseResolucao{
	  ...
	  public function Insere(){
		...
		$query = "BEGIN PCK_FaseResolucao.prcInsert(:ppsDESCRICAO, :ppsCIND_OBJ_CNTRR, :ppnID, :ppnSQLCODE, :ppsSQLERRM); END;";
	  ...
	  public function Atualiza(){
		...
		$this->ppnSQLCODE = '';
		$this->ppsSQLERRM = '';
		$query = "BEGIN PCK_FaseResolucao.prcUpdate(:ppnID, :ppsDESCRICAO, :ppsCIND_OBJ_CNTRR, :ppnSQLCODE, :ppsSQLERRM); END;";
		$stmt = oci_parse(self::$conn, $query);
    ...
    public function Exclui(){
		...
		$this->ppnSQLCODE = '';
		$this->ppsSQLERRM = '';
		$query = "BEGIN PCK_FaseResolucao.prcDelete(:ppnID, :ppsCIND_OBJ_CNTRR, :ppnSQLCODE, :ppsSQLERRM); END;";
		$stmt = oci_parse(self::$conn, $query);
    ...
    public function Restaura(){
		...
		$this->ppnSQLCODE = '';
		$this->ppsSQLERRM = '';
		$query = "BEGIN PCK_FaseResolucao.prcRestaura(:ppnID, :ppsCIND_OBJ_CNTRR, :ppnSQLCODE, :ppsSQLERRM); END;";
		$stmt = oci_parse(self::$conn, $query);
  ...
  function Carrega($prmid){
		...
		$ppnSQLCODE = '';
		$ppsSQLERRM = '';
		$query = "BEGIN PCK_FaseResolucao.prcSelect(:ppnID, :ppsDESCRICAO, :ppnSQLCODE, :ppsSQLERRM); END;";
		$stmt = oci_parse(self::$conn, $query);
		...
		$this->id = $ppnID;
		$this->descricao = $ppsDESCRICAO;
	}

  static function CarregaFaseResolucao($id){
  		self::ConectaBD();
  		$ppnID = $id;
		$ppsDESCRICAO = '';
		$ppsCIND_OBJ_CNTRR = 'S';
    ...
    static function ListarTodosAtivos(){
		...
		$ppnSQLCODE = '';
		$ppsSQLERRM = '';
		$query = "BEGIN PCK_FaseResolucao.prcListarTodosAtivos(:ppsLISTAGEM, :ppnSQLCODE, :ppsSQLERRM); END;";
		$stmt = oci_parse(self::$conn, $query);
    ...
    static function ListarTodosInativos(){
		...
		$ppnSQLCODE = '';
		$ppsSQLERRM = '';
		$query = "BEGIN PCK_FaseResolucao.prcListarTodosInativos(:ppsLISTAGEM, :ppnSQLCODE, :ppsSQLERRM); END;";
		$stmt = oci_parse(self::$conn, $query);
    ...
    static function ListarTodosArray(){
		...
		$ppnSQLCODE = '';
		$ppsSQLERRM = '';
		$query = "BEGIN PCK_FaseResolucao.prcListarArray(:ppsLISTAGEM, :ppnSQLCODE, :ppsSQLERRM); END;";
		$stmt = oci_parse(self::$conn, $query);
