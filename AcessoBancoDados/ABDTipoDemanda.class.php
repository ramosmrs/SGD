<?PHP
  ...
  class ABDTipoDemanda extends TipoDemanda{
	  ...
	  public function Insere(){
		...
		$query = "BEGIN PCK_TIPODEMANDA.prcInsert(:ppsDESCRICAO, :ppsCIND_OBJ_CNTRR, :ppnID, :ppnSQLCODE, :ppsSQLERRM); END;";
	  ...
	  public function Atualiza(){
		...
		$this->ppnSQLCODE = '';
		$this->ppsSQLERRM = '';
		$query = "BEGIN PCK_TIPODEMANDA.prcUpdate(:ppnID, :ppsDESCRICAO, :ppsCIND_OBJ_CNTRR, :ppnSQLCODE, :ppsSQLERRM); END;";
		$stmt = oci_parse(self::$conn, $query);
    ...
    public function Exclui(){
		...
		$this->ppnSQLCODE = '';
		$this->ppsSQLERRM = '';
		$query = "BEGIN PCK_TIPODEMANDA.prcDelete(:ppnID, :ppsCIND_OBJ_CNTRR, :ppnSQLCODE, :ppsSQLERRM); END;";
		$stmt = oci_parse(self::$conn, $query);
    ...
    public function Restaura(){
		...
		$this->ppnSQLCODE = '';
		$this->ppsSQLERRM = '';
		$query = "BEGIN PCK_TIPODEMANDA.prcRestaura(:ppnID, :ppsCIND_OBJ_CNTRR, :ppnSQLCODE, :ppsSQLERRM); END;";
		$stmt = oci_parse(self::$conn, $query);
  ...
  function Carrega(){
		...
		$this->ppnSQLCODE = '';
		$this->ppsSQLERRM = '';
		$query = "BEGIN PCK_TIPODEMANDA.prcSelect(:ppnID, :ppsDESCRICAO, :ppnSQLCODE, :ppsSQLERRM); END;";
		$stmt = oci_parse(self::$conn, $query);
  ...
  static function CarregaTipoDemanda($id){
  		self::ConectaBD();
  		$ppnID = $id;
		$ppsDESCRICAO = '';
		$ppsCIND_OBJ_CNTRR = 'S';
    ...
    static function ListarTodosAtivos(){
		...
		$ppnSQLCODE = '';
		$ppsSQLERRM = '';
		$query = "BEGIN PCK_TIPODEMANDA.prcListarTodosAtivos(:ppsLISTAGEM, :ppnSQLCODE, :ppsSQLERRM); END;";
		$stmt = oci_parse(self::$conn, $query);
    ...
    static function ListarTodosInativos(){
		...
		$ppnSQLCODE = '';
		$ppsSQLERRM = '';
		$query = "BEGIN PCK_TIPODEMANDA.prcListarTodosInativos(:ppsLISTAGEM, :ppnSQLCODE, :ppsSQLERRM); END;";
		$stmt = oci_parse(self::$conn, $query);
    ...
    static function ListarTodosArray(){
		...
		$ppnSQLCODE = '';
		$ppsSQLERRM = '';
		$query = "BEGIN PCK_TIPODEMANDA.prcListarArray(:ppsLISTAGEM, :ppnSQLCODE, :ppsSQLERRM); END;";
		$stmt = oci_parse(self::$conn, $query);
