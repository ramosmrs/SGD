...
class SituacaoControle extends TPage
{
    ...
    public function __construct()
    {
    	...
    	//	new TMessage('error', 'Somente administradores podem utilizar o cadastro de situaчуo.');
        }
        else{
        
        $this->form = new TForm('form_busca_Situacao');
        ...
        //Tэtulo da pсgina
        $tbtitulo = new TTable;
        $Titulo = new TLabel('Cadastro das Situaчѕes');
    ...
    {
		$tpusuario = array();
		$tpusuario = ABDSituacao::ListarTodosArray();
        $this->datagrid->clear();
        if ($tpusuario)
        {
    ...
    function onSave()
    {
        ...
        $Situacao = $this->form->getData('ABDSituacao');
    	$mensagem = $Situacao->Atualiza();  
        // recarrega listagem
        $this->onReload();
    ...
    function onEdit($param)
    {
        ...
        $tpusuario = ABDSituacao::CarregaSituacao($param['key']);
