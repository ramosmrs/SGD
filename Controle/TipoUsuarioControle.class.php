...
class TipoUsuarioControle extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form = new TForm('form_busca_tipousuario');
        ...
        //Título da página
        $tbtitulo = new TTable;
        $Titulo = new TLabel('Cadastro dos tipos de usuários');
    ...
    {
		$tpusuario = array();
		$tpusuario = ABDTipoUsuario::ListarTodosArray();
        $this->datagrid->clear();
        if ($tpusuario)
        {
    ...
    function onSave()
    {
        $tipousuario = $this->form->getData('ABDTipoUsuario');
    ...
    function onEdit($param)
    {
        ...
        $tpusuario = ABDTipoUsuario::CarregaTipoUsuario($param['key']);
