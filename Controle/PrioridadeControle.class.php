...
class PrioridadeControle extends TPage
{
    ...
    public function __construct()
    {
    	...
    	//	new TMessage('error', 'Somente administradores podem utilizar o cadastro de prioridade.');
        }
        else{
        
        $this->form = new TForm('form_busca_Prioridade');
        ...
        $action1->setField('id');
        $action1->setParameter('title', 'Editar');
        ...
        //Título da página
        $tbtitulo = new TTable;
        $Titulo = new TLabel('Cadastro das Prioridades');
    ...
    {
		$tpusuario = array();
		$tpusuario = ABDPrioridade::ListarTodosArray();
        $this->datagrid->clear();
        if ($tpusuario)
        {
    ...
    function onSave()
    {
        ...
        $Prioridade = $this->form->getData('ABDPrioridade');
    ...
    function onEdit($param)
    {
        ...
        $tpusuario = ABDPrioridade::CarregaPrioridade($param['key']);
